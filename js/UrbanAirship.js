...
const NOTIFICATION_OPT_IN_STATUS =
	'com.urbanairship.notification_opt_in_status';
...
class UrbanAirship {
	...
	static setNotificationSound(fileName: string) {
		UrbanAirshipModule.setNotificationSound(fileName);
	}
}
